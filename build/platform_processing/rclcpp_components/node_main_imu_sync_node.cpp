...
#define NODE_MAIN_LOGGER_NAME "imu_sync_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimu_sync_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<platform_processing::ImuSyncComponent>";
