...
#define NODE_MAIN_LOGGER_NAME "dronecan_bridge_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdronecan_bridge_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<uavcan_bridge::DronecanBridgeComponent>";
